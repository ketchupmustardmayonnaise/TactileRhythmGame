...
pub struct ViewConfig {
    ...
    // 캔버스 테두리 두께
    pub canvas_border_width: i16,
    // 커서 두께
    pub cursor_stroke_width: i16,
}
...
pub struct DrawConfig {
    ...
    pub max_radius: i16,
    // 최대 브러시 반지름
    pub default_radius: i16, // 기본 브러시 반지름
}
